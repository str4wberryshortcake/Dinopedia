...
export const dinosaurs = [
    ...
    {
      name: "Velociraptor",
      dinoIMG: "https://www.howitworksdaily.com/wp-content/uploads/2015/06/Velociraptor_infobox.png",
    ...
    {
      name: "Triceratops",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicworld-evolution/images/8/85/Triceratops_JWE2_Profile.png/revision/latest?cb=20220613222443",
      yearsAgo: "68-66 million years ago",
      group: "Ornithischia",
      clade: "Ornithischia",
    ...
    {
      name: "Stegosaurus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicworld-evolution/images/1/1b/Stegosaurus_JWE2_Profile.png/revision/latest?cb=20220613214856",
    ...
    {
      name: "Brachiosaurus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicpark/images/5/51/Jurassic_world_brachiosaurus_updated_by_sonichedgehog2-dc55jvt.png/revision/latest?cb=20180427201052",
    ...
    {
      name: "Allosaurus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicworld-evolution/images/a/ab/Allosaurus_JWE2_Profile.png/revision/latest?cb=20220601223404",
      yearsAgo: "155-150 million years ago",
      group: "Saurischia",
      clade: "Theropoda",
    ...
    {
      name: "Spinosaurus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicpark/images/6/68/Spinosaurus_Hunter.Image.png/revision/latest/scale-to-width-down/250?cb=20250407221901",
    ...
    {
      name: "Ankylosaurus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicpark/images/4/47/RebirthAnkylosaurus.png/revision/latest?cb=20250411015057",
      yearsAgo: "68-66 million years ago",
      group: "Ornithischia",
      clade: "Thyreophora",
    ...
    {
      name: "Diplodocus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicworld-evolution/images/b/b9/Diplodocus_JWE2_Profile.png/revision/latest?cb=20220603225354",
    ...
    },
    {
      ...
      dinoIMG: "https://static.wikia.nocookie.net/jurassicpark/images/d/d1/JWD_Parasaurolophus.png/revision/latest?cb=20220618082154",
    ...
    {
      name: "Iguanodon",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicpark/images/c/c6/Iguanodon_render.png/revision/latest?cb=20240531104621",
    ...
    },
    {
      ...
      dinoIMG: "https://static.wikia.nocookie.net/jurassicpark/images/e/ee/Jurassic_park_pachycephalosaurus_by_camo_flauge-dcfu6qx.png/revision/latest?cb=20180709072242",
    ...
    {
      name: "Carnotaurus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicpark/images/b/b9/Jurassic_world_carnotaurus_updated_by_sonichedgehog2-dc377dl.png/revision/latest?cb=20180427200251",
    ...
    {
      name: "Utahraptor",
      dinoIMG: "https://static.wikia.nocookie.net/pkgame/images/7/73/Utahraptor_Woodchip.png/revision/latest?cb=20201108012515",
    ...
    {
      name: "Compsognathus",
      dinoIMG: "https://static.wikia.nocookie.net/jurassicworld-evolution/images/c/c7/Compsognathus_JWE2_Profile.png/revision/latest?cb=20220602231332",
...
export const quizQuestions = [
  { 
    id: 1, 
    text: "Your ideal Saturday plan is…", 
    options: [
      { label: "Tracking down the city’s best new food truck...", value: 'H', axis: 'diet' },
      { label: "Hosting a slow, pot-luck brunch with friends...", value: 'G', axis: 'diet' }
    ]
  },
  { 
    id: 2, 
    text: "In group projects, you secretly wish you could…", 
    options: [
      { label: "Handle every critical piece yourself...", value: 'S', axis: 'social' },
      { label: "Divide and conquer with a tight crew...", value: 'C', axis: 'social' }
    ]
  },
  { 
    id: 3, 
    text: "Faced with a locked puzzle box, you’d rather…", 
    options: [
      { label: "Study the mechanism, test hypotheses...", value: 'I', axis: 'decision' },
      { label: "Fiddle until something clicks...", value: 'T', axis: 'decision' }
    ]
  },
  { 
    id: 4, 
    text: "On a long hike, you’re the one who…", 
    options: [
      { label: "Sprints ahead to check the trail...", value: 'D', axis: 'motion' },
      { label: "Sets a steady cadence and just keeps going...", value: 'E', axis: 'motion' }
    ]
  },
  { 
    id: 5, 
    text: "Dinner’s at 7 p.m. but you’re starving at 5. You…", 
    options: [
      { label: "Hunt the pantry for quick protein...", value: 'H', axis: 'diet' },
      { label: "Sip tea and wait it out...", value: 'G', axis: 'diet' }
    ]
  },
  { 
    id: 6, 
    text: "Vacation time! You pick…", 
    options: [
      { label: "A solo backpacking route...", value: 'S', axis: 'social' },
      { label: "A festival packed with friends...", value: 'C', axis: 'social' }
    ]
  },
  { 
    id: 7, 
    text: "New video game drops tomorrow. You…", 
    options: [
      { label: "Read guides and plot an efficient skill tree...", value: 'I', axis: 'decision' },
      { label: "Dive in blind; discovery is half the joy.", value: 'T', axis: 'decision' }
    ]
  },
  { 
    id: 8, 
    text: "You’re crossing campus in a downpour. Umbrella busted. You…", 
    options: [
      { label: "Dash between awnings in explosive bursts...", value: 'D', axis: 'motion' },
      { label: "Power-walk in a purposeful march...", value: 'E', axis: 'motion' }
    ]
  },
  { 
    id: 9, 
    text: "Someone challenges you to a cook-off. First move?", 
    options: [
      { label: "Research recipes, experiment, iterate...", value: 'I', axis: 'decision' },
      { label: "Trust your taste buds, throw spice to the wind...", value: 'T', axis: 'decision' }
    ]
  },
  { 
    id: 10, 
    text: "Friends are late to the movie. You…", 
    options: [
      { label: "Grab seats alone, saving spots with jackets...", value: 'S', axis: 'social' },
      { label: "Wait outside so the crew enters together...", value: 'C', axis: 'social' }
    ]
  }
];

export const dinoMap = {
  HSID: 'Troodon',
  HSIE: 'Tyrannosaurus rex',
  HSTD: 'Spinosaurus',
  HSTE: 'Carnotaurus',
  HCID: 'Deinonychus',
  HCIE: 'Giganotosaurus',
  HCTD: 'Dakotaraptor',
  HCTE: 'Albertosaurus',
  GSID: 'Therizinosaurus',
  GSIE: 'Ankylosaurus',
  GSTD: 'Pachycephalosaurus',
  GSTE: 'Stegosaurus',
  GCID: 'Leaellynasaura',
  GCIE: 'Parasaurolophus',
  GCTD: 'Maiasaura',
  GCTE: 'Brachiosaurus'
};

export const dinoProfiles = [
  {
    code: 'HSID',
    name: 'Troodon',
    image: 'https://lh5.googleusercontent.com/proxy/-XiOVU9osDtd5BzPtmoF6cc3y6AEKZscVOAkbExzi08gsrfsPnwRyOD18VHHFVUblb0y6ZYE36kANX0uvrOp1CNKkzo8IwOP5DKx4qXAtnT04KofKuhqFhGLJ77V5WzjtQ',
    description: `A razor-sharp freelance hacker who works alone at 3 a.m., devouring espresso shots and complex problems with the same predatory focus it once used for prey.`
  },
  {
    code: 'HSIE',
    name: 'Tyrannosaurus rex',
    image: 'https://static.wikia.nocookie.net/jurassicpark/images/4/42/Jurassic_Park_Tyrannosaurus_Rex.png/revision/latest/scale-to-width-down/1200?cb=20220425020331',
    description: `The charismatic CEO who commands a boardroom by sheer presence; strategic, deliberate, happy to let others scurry while they make the big, slow moves that matter.`
  },
  {
    code: 'HSTD',
    name: 'Spinosaurus',
    image: 'https://static.wikia.nocookie.net/neutral-characters/images/6/6b/JP3Spinosaurus.png/revision/latest?cb=20240518090741',
    description: `The adrenaline-junkie adventure vlogger—dives with crocodiles at dawn, wing-suits off cliffs at noon, and trusts raw instinct to keep the show (and them) alive.`
  },
  {
    code: 'HSTE',
    name: 'Carnotaurus',
    image: 'https://image-service.zaonce.net/eyJidWNrZXQiOiJmcm9udGllci1jbXMiLCJrZXkiOiIyMDIxLTA4L2Nhcm5vdGF1cnVzLnBuZyIsImVkaXRzIjp7IndlYnAiOnsicXVhbGl0eSI6ODV9LCJ0b0Zvcm1hdCI6IndlYnAiLCJyZXNpemUiOnsid2lkdGgiOjgwMCwiZml0IjoiY29udGFpbiJ9fX0=',
    description: `A no-nonsense nightclub bouncer: imposing, instinct-led, not big on words, but you absolutely feel safer (or more intimidated) when they’re on the door.`
  },
  {
    code: 'HCID',
    name: 'Deinonychus',
    image: 'https://lh3.googleusercontent.com/proxy/rl4RTBng0_XPW5hnFUtQ9h69niKq8YyND8cVOD4utjXRe5bizF17CGYGl4A8_yeEovGODvHjs3--urVqBW8QX0_fCttg3J4m9DN63O4jIvuQBcvTxJ3LkKZZ4fx8Hg1DhfWC0oBk8ec',
    description: `A start-up’s agile team lead who prototypes faster than most people brainstorm, thrives on collaboration, and revels in clever flanking maneuvers against bigger competitors.`
  },
  {
    code: 'HCIE',
    name: 'Giganotosaurus',
    image: 'https://static.wikia.nocookie.net/jurassicworld-evolution/images/d/da/GigaTundra.png/revision/latest?cb=20200424213903',
    description: `A seasoned military commander—organized, calculating, and perfectly willing to spend the night planning before the dawn offensive with the squad.`
  },
  {
    code: 'HCTD',
    name: 'Dakotaraptor',
    image: 'https://static.wikia.nocookie.net/dino/images/8/84/Tumblr_ohcjoohuzJ1s5f2yxo1_1280.png/revision/latest?cb=20171211191551',
    description: `That high-energy street-skate crew captain who lives for the next trick, feeds off group hype, and happily wings it without a safety net.`
  },
  {
    code: 'HCTE',
    name: 'Albertosaurus',
    image: 'https://i.cbc.ca/1.3752891.1718291019!/fileImage/httpImage/image.png_gen/derivatives/16x9_1180/alberta-dino.png?im=Resize%3D780',
    description: `A rugby forward: powerful, team-minded, runs on practiced drills and bone-deep reflexes, bulldozes obstacles for the rest of the pack.`
  },
  {
    code: 'GSID',
    name: 'Therizinosaurus',
    image: 'https://www.dododex.com/media/creature/therizinosaurus.png',
    description: `An eccentric vegan sculptor—tall, reclusive, brilliantly creative, slicing through marble the way its claws once raked foliage.`
  },
  {
    code: 'GSIE',
    name: 'Ankylosaurus',
    image: 'https://www.dndbeyond.com/avatars/thumbnails/47144/533/1000/1000/638742152320179115.png',
    description: `The soft-spoken security-systems engineer: fortress-minded, methodical, happiest when reinforcing the defenses—and themselves—against life’s surprises.`
  },
  {
    code: 'GSTD',
    name: 'Pachycephalosaurus',
    image: 'https://static.wikia.nocookie.net/jurassicworld-evolution/images/d/d2/PachyArid.png/revision/latest?cb=20200424221037',
    description: `A fearless parkour athlete who literally leads with their head, sprinting into challenges first and sorting the details mid-air.`
  },
  {
    code: 'GSTE',
    name: 'Stegosaurus',
    image: 'https://static.wikia.nocookie.net/jurassicworld-evolution/images/1/1b/Stegosaurus_JWE2_Profile.png/revision/latest?cb=20220613214856',
    description: `A gentle community gardener—routine-oriented, blissful in their own lane, but swing a tail (metaphorically) if you mess with their plants.`
  },
  {
    code: 'GCID',
    name: 'Leaellynasaura',
    image: 'https://via.placeholder.com/150?text=Leaellynasaura',
    description: `The irrepressible polar-research grad student: fast thinker, faster talker, thrives in tight-knit field teams and eternal “daylight.”`
  },
  {
    code: 'GCIE',
    name: 'Parasaurolophus',
    image: 'https://via.placeholder.com/150?text=Parasaurolophus',
    description: `A choir director and sound designer rolled into one—loves harmonious group projects, values clear communication, and plays the long game on creative visions.`
  },
  {
    code: 'GCTD',
    name: 'Maiasaura',
    image: 'https://via.placeholder.com/150?text=Maiasaura',
    description: `The bustling school nurse or camp counselor who can calm a stampede of kids on instinct and still sprint to grab supplies before anyone even asks.`
  },
  {
    code: 'GCTE',
    name: 'Brachiosaurus',
    image: 'https://via.placeholder.com/150?text=Brachiosaurus',
    description: `A patient re-wilding conservationist overseeing century-long forest projects—sees above the noise, moves deliberately, and never loses sight of the horizon.`
  }
];
...
export const axisDefinitions = [
  {
    ...
    letter2: 'G',
    letter2Label: 'Grazer',
    description: 'Predatory gusto vs. plant-powered chill'
  },
  {
    axis: 'Social Style',
    letter1: 'S',
    ...
    letter2: 'C',
    letter2Label: 'Clan',
    description: 'Lone wolf vs. herd/pack team-up'
  },
  {
    axis: 'Decision Gear',
    letter1: 'I',
    letter1Label: 'Intel',
    letter2: 'T',
    letter2Label: 'Instinct',
    description: 'Plans & puzzles vs. gut & muscle memory'
  },
  {
    axis: 'Motion Mode',
    letter1: 'D',
    letter1Label: 'Dynamic',
    letter2: 'E',
    letter2Label: 'Enduring',
    description: 'Fast, agile bursts vs. steady, long-game stamina'
  }
];